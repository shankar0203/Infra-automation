# Project: Automated Deployment of HTTPD Server using Ansible, Terraform, and Jenkins on AWS
 ...
 # Copy and paste the cmd as shell cmds under post build action
 - Copy shell cmds from -> Infra-automation/Infra-automation/cmds
 - Paste the cmds in post build section as shell cmds
